...
*   **Interactive API Docs (Swagger UI):** [https://careerforge-backend-wery.onrender.com](https://careerforge-backend-wery.onrender.com) 🚀 *(Clicking this live URL will automatically redirect HR, recruiters, and developers to the interactive Swagger UI to test all endpoints live)*
